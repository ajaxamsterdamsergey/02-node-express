let tokenMiddleware;_9a1‍.w("../middlewares/auth.middleware",[["tokenMiddleware",["tokenMiddleware"],function(v){tokenMiddleware=v}]]);const { Router } = require("express");
...
contactsRouter.get("/", tokenMiddleware, contactController.getContacts);
contactsRouter.get(
  "/:id",
  tokenMiddleware,
